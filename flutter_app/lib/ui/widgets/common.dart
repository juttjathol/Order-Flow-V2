...
class BrandMark extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Image.asset(
      ...
      width: size,
      height: size,
      errorBuilder: (_, __, ___) => Icon(Icons.bolt, size: size, color: OfColors.mint),
    );
  }
}
...
int gridCount(BuildContext context, {int phone = 2, int tablet = 3}) =>
...
class KeepAliveBanner extends ConsumerWidget {
  const KeepAliveBanner({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return const SizedBox.shrink();
  }
